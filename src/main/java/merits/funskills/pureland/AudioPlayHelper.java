...
public class AudioPlayHelper {
    ...
    private AudioPlayHelper(final AmazonS3 amazonS3Client, final AmazonDynamoDB dynamoClient) {
    ...
    public static AudioPlayHelper getInstance() {
        ...
        AmazonDynamoDB dynamoClient = AmazonDynamoDBClientBuilder.standard()
            .withRegion("us-east-1")
            .build();
        _instance = new AudioPlayHelper(s3client, dynamoClient);
        return _instance;
    }
    ...
    private DynamoDBMapperConfig getConfig(final SaveBehavior saveBehavior) {
        return DynamoDBMapperConfig.builder()
            .withTableNameOverride(new TableNameOverride(AppConfig.getPlayTable()))
    ...
    public void saveUserSettings(final UserSetting setting) {
        DynamoDBMapperConfig config = getConfig(SaveBehavior.UPDATE_SKIP_NULL_ATTRIBUTES);
